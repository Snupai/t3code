...
import { ServerConfigUpdatedPayload, ServerInspectProvidersInput } from "./server";
...
export const WS_METHODS = {
  ...
  serverInspectProviders: "server.inspectProviders",
...
const WebSocketRequestBody = Schema.Union([
  ...
  tagRequestBody(WS_METHODS.serverInspectProviders, ServerInspectProvidersInput),
